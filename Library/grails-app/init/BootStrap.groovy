...
class BootStrap {
	...
	def Library1=new Library(book: 'IT for Dumbies',
				student:'Scott Daniels',
				location:'Sheffield',
				openingHours:'24hrs',
				librarian:'Dan').save()

	def Library2=new Library(book: 'Media for Dumbies',
				student:'Lee Leaf',
				location:'Birmingham',
				openingHours:'24hrs',
				librarian:'Garry').save()

	def Library3=new Library(book: 'English for Dumbies',
				student:'Peter Plant',
				location:'London',
				openingHours:'24hrs',
				librarian:'Ted').save()
